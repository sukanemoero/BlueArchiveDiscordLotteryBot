...
public interface ICharacterData : IDatabase
{
    ...
    public class CharacterDataType(uint id)
    {
        ...
        protected internal string Profile { get; set; } = "";
        ...
        protected internal uint BaseStar { get; set; }
        protected internal string Position { get; set; } = "";
        protected internal string Role { get; set; } = "";
        protected internal string ArmorType { get; set; } = "";
        protected internal string AttackType { get; set; } = "";
        protected internal string WeaponType { get; set; } = "";
        protected internal string SquadType { get; set; } = "";
        protected internal string School { get; set; } = "";

        public class TerrainValue
        {
            protected internal uint City { get; set; }
            protected internal uint Desert { get; set; }
            protected internal uint Indoor { get; set; }
        }
